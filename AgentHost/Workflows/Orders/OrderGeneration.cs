...
public class StaticOrderGenerator : IOrderGenerator
{
    public async Task<string> GenerateRandomOrder()
    {
        var randomOrders = new List<string>
        {
            ...
            "2 bacon cheeseburgers, 1 order of regular fries and 1 waffle fries, and 2 chocolate milkshakes",
            ...
            "1 bacon cheeseburger with extra cheese, 1 order of onion rings, and 1 vanilla milkshake with sprinkles",
            "2 cheeseburgers, 1 order of sweet potato fries, and 2 chocolate milkshakes with whipped cream",
            "1 cheeseburger with bacon, 1 order of fries without salt, 1 order of onion rings, and 1 strawberry milkshake with a cherry on top",
