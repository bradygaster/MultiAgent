...
public class DessertTools(ILogger<DessertTools> logger)
{
    ...
    public string MakeSundae(MakeSundaeRequest request) => LogAndReturn($"🍨 Making {request.Size} sundae with {request.Flavor} ice cream and {request.Toppings}... Delicious sundae ready!");
